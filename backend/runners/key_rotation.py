...
Usage:
    from backend.runners.key_rotation import get_api_key, mark_exhausted
...
def _load_keys() -> list[str]:
    ...
    # Look for .env at the repo root first, then inside the backend package.
    here = Path(__file__).resolve()
    repo_root = here.parents[2]          # backend/runners/key_rotation.py -> repo root
