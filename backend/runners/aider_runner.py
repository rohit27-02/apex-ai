...
class AiderRunner:
    ...
    def __init__(
        ...
        # BYOK: an explicit key (e.g. entered in the frontend) takes precedence
        # over the rotating keys loaded from .env. Never logged or persisted.
        self._api_key = api_key or None
        # aider may live in a separate venv (e.g. when the orchestrator runs on a
        # Python too new for aider's wheels). AIDER_BIN overrides the binary path.
        self._aider_bin = os.environ.get("AIDER_BIN", "aider")
